...
export default defineConfig({
 ...
 formats: ["cjs", "es"], // Especifica los formatos de salida (móduloCommonJS y ES).
 },
 rollupOptions: {
 external: [...Object.keys(peerDependencies)], // Define dependenciasexternas para rollup.
 },
 sourcemap: true, // Genera sourcemaps para depurar.
 emptyOutDir: true, // Borra el directorio de salida antes de compilar.
 },
 plugins: [dts()], // Utiliza el complemento 'vite-plugin-dts' para generararchivos de declaración de TypeScript (d.ts).
 test: {
    globals: true,
    environment: "jsdom",
